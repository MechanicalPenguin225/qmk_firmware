...
/*|-----------------------------------------------------|                      |-----------------------------------------------------| */
/*| Tab    |   B    |   É    |   P    |   O    |   È    |                      |   /    |   7    |   8    |   9    |   -    |Num Lock| */
  _______  , _______, _______, _______, _______, _______,                        KC_PSLS, KC_P7  , KC_P8  , KC_P9  , KC_PMNS, KC_NUM ,
/*|-----------------------------------------------------|                      |-----------------------------------------------------| */
/*|LShift  |   A    |   U    |   I    |   E    |   ,    |---------.  ,---------|   *    |   4    |   5    |   6    |   +    |  M     | */
  _______  , _______, _______, _______, _______, _______,                        KC_PAST, KC_P4  , KC_P5  , KC_P6  , KC_PPLS, _______,
/*|-----------------------------------------------------|   Ê     |  |  Num =  |-----------------------------------------------------| */
/*|LCTRL   |  *Ç*   |  *W*   |   X    |   .    |   K    |---------|  |---------|   0    |   1    |   2    |   3    |   ,    | RCtrl  | */
  _______  , BP_CCED, BP_W   , _______, _______, _______, _______ ,     KC_PEQL, KC_P0  , KC_P1  , KC_P2  , KC_P3  , KC_PCMM, _______,
/* `----------------------------------------------------/         /  \         \-----------------------------------------------------' */
/*                        | LGUI   | LOWER   |LShift  | /ENTER    /    \SPACE    \  |BackSP   |RAISE    |  Alt   | */
